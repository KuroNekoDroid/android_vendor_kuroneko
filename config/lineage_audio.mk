...
ALARM_PATH := vendor/kuroneko/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/kuroneko/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/kuroneko/prebuilt/common/media/audio/ringtones
